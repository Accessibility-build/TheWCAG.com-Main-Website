 ...
 * Matches based on defendant name (normalized) and year
 */
export function findMatchingDetailedLawsuit(
  archiveDefendant: string,
  archiveYear: string
): Lawsuit | undefined {
  // Normalize defendant name for matching (remove common suffixes, normalize case)
  ...
  // Split on "and" to handle multiple defendants
  ...
  return lawsuits.find((lawsuit) => {
    ...
    // Check if any defendant name matches (after normalization)
    // Match if any archive defendant is included in any lawsuit defendant or vice versa
    ...
    // Check if year matches (within 1 year tolerance for filing dates)
