...
import { removeMetadata } from "@/lib/tools/converters/image"
...
export default function ImageMetadataRemoverPage() {
  ...
  const handleRemoveMetadata = async () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : "Metadata removal failed")
    } finally {
            ...
            <div className="grid gap-6 lg:grid-cols-2">
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <p className="text-sm text-muted-foreground">
                        This will remove all EXIF data, GPS coordinates, camera information, and editing history from your image to protect your privacy.
                      </p>
                      <Button
              ...
              <div>
                <ConversionResult
                  ...
                  downloadFilename={file ? `${file.name.split(".")[0]}-no-metadata.png` : undefined}
