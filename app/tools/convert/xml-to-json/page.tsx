...
import { xmlToJson } from "@/lib/tools/converters/text"
...
export default function XmlToJsonPage() {
  ...
  const handleConvert = () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : "Conversion failed. Make sure your XML is valid.")
    }
  }
                ...
                <Card>
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-lg">XML Input</CardTitle>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="xml-input">Enter XML</Label>
                      <Textarea
                        id="xml-input"
                        value={input}
