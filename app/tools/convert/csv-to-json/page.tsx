...
import { csvToJson } from "@/lib/tools/converters/text"
...
export default function CsvToJsonPage() {
  ...
  const handleConvert = () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : "Conversion failed. Make sure your CSV is valid.")
    }
  }
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="csv-input">Enter CSV Data</Label>
                      <Textarea
                        id="csv-input"
                        value={input}
