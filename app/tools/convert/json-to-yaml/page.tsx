...
import { jsonToYaml } from "@/lib/tools/converters/text"
...
export default function JsonToYamlPage() {
  ...
  const handleConvert = () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : "Conversion failed. Make sure your JSON is valid.")
    }
  }
  ...
  const handleDownload = () => {
    downloadFile(output, "converted.yaml", "text/yaml")
  }
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <div className="space-y-4">
                <Card>
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-lg">YAML Output</CardTitle>
                      {output && (
                        <div className="flex gap-2">
