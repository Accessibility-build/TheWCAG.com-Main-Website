...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive guide to accessibility testing. Learn how to test websites for WCAG compliance using automated tools, manual testing, screen readers, and user testing.",
  keywords: [
