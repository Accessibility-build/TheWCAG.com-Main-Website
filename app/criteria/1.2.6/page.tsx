...
import { CheckCircle2, XCircle, Copy, Check, Hand, Video } from "lucide-react"
...
export default function SignLanguagePrerecordedPage() {
  const [copiedCode, setCopiedCode] = useState<string | null>(null)
  const criterion = getCriterionById("1-2-6")
    ...
    breadcrumb: {
      ...
      itemListElement: [
        ...
        },
        {
          "@type": "ListItem",
          position: 2,
          name: criterion.principle.charAt(0).toUpperCase() + criterion.principle.slice(1),
        ...
        },
        {
          ...
          item: `https://thewcag.com/criteria/${criterion.number}`,
        },
      ],
    },
    mainEntity: {
    ...
    <>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-sm text-muted-foreground">{criterion.principle.charAt(0).toUpperCase() + criterion.principle.slice(1)} → {criterion.guideline}</span>
        </div>
