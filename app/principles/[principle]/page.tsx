          ...
          <div className="container py-8 md:py-12 max-w-5xl">
            ...
            <div className="mb-12">
              <div className="flex items-start gap-4 mb-4">
                <div
                  className={`w-16 h-16 rounded-xl bg-${colorMap[principle as keyof typeof colorMap]}/10 flex items-center justify-center shrink-0`}
                >
                  <Icon className={`h-8 w-8 text-${colorMap[principle as keyof typeof colorMap]}`} aria-hidden="true" />
                </div>
                <div className="flex-1">
                  <h1 className="text-4xl md:text-5xl font-bold mb-4 capitalize">{principleData.title}</h1>
                  <p className="text-xl text-muted-foreground leading-relaxed">{principleData.description}</p>
                </div>
              </div>
            </div>
