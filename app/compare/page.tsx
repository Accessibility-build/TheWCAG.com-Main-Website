...
export default function ComparePage() {
  const structuredData = {
    ...
    "@type": "CollectionPage",
    name: "Accessibility Tools & Services Comparison",
    description:
      "Compare popular web accessibility tools, services, screen readers, and testing solutions. Find the best accessibility tools for your needs.",
    url: "https://thewcag.com/compare",
    breadcrumb: {
      "@type": "BreadcrumbList",
      itemListElement: [
        ...
        },
        {
          ...
          position: 2,
          name: "Compare Tools",
          item: "https://thewcag.com/compare",
        },
      ],
    },
  }
          ...
          <div className="container py-6 sm:py-8 md:py-12 max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-8 sm:mb-12">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">Accessibility Tools Comparison</h1>
              </div>
